...
public class S3File {
	...
	public String toString() {
		return "S3File [bucketName=" + bucketName + ", keyName=" + keyName + ", filePath=" + filePath + ", category="
				+ category + "]";
	}
	public S3File(String bucketName, String keyName, String filePath, String category) {
		super();
		this.bucketName = bucketName;
		this.keyName = keyName;
		this.filePath = filePath;
